...
<div class="flex flex-col h-screen">
    ...
    <div class="mb-auto mx-auto items-center px-2">
        ...
        <br>
        <Collapse title="Why can't I find a specific movie or TV show?"
        ...
        <Collapse title="Why don't you support more countries?"
                  description="As we’re a newly started company our resources are at this time sparse.

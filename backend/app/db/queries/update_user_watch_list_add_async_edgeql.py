# AUTOGENERATED FROM 'backend/app/db/queries/update_user_watch_list_add.edgeql' WITH:
...
class UpdateUserWatchListAddResult(NoPydanticValidation):
    id: uuid.UUID
...
async def update_user_watch_list_add(
    ...
    *,
    email: str,
    streamchaser_id: str,
) -> UpdateUserWatchListAddResult | None:
